...
$matrix = [
    ...
    '7.1'  => [
        '^3.0.0' => ['2.7.*', '2.8.*', '3.0.*', '3.1.*', '3.2.*', '3.3.*', '3.4.*', '4.0.*', '4.1.*', '4.2.*'],
    ],
    '7.2'  => [
        '^2.7.1' => ['2.7.*', '2.8.*', '3.0.*', '3.1.*', '3.2.*', '3.3.*', '3.4.*', '4.0.*', '4.1.*', '4.2.*', '4.3.x-dev'],
        '^3.0.0' => ['2.7.*', '2.8.*', '3.0.*', '3.1.*', '3.2.*', '3.3.*', '3.4.*', '4.0.*', '4.1.*', '4.2.*', '4.3.x-dev'],
    ],
    '7.3'  => [
        '^2.7.1' => ['2.7.*', '2.8.*', '3.0.*', '3.1.*', '3.2.*', '3.3.*', '3.4.*', '4.0.*', '4.1.*', '4.2.*', '4.3.x-dev'],
        '^3.0.0' => ['2.7.*', '2.8.*', '3.0.*', '3.1.*', '3.2.*', '3.3.*', '3.4.*', '4.0.*', '4.1.*', '4.2.*', '4.3.x-dev'],
